        ...
        <div className=" relative">
          ...
          >
            ...
            <motion.div
              ...
              variants={fadeIn}
            >
              <Link href={"/use-cases"} className=" group text-xl flex flex-row">
                  See why global innovators choose us
                    <ChevronRight className="size-10 relative -left-7 top-6 group-hover:-left-5 transition-all duration-500" />
              </Link>
            </motion.div>
