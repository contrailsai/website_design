            ...
            <SectionReveal delay={0.1}>
                <div className=" h-[150vh] md:h-[135vh] w-full">
                    <div className="flex flex-col-reverse md:flex-row justify-between gap-5 pb-10 md:pb-0 ">
                        ...
                        >
                            <div className="md:w-[530px] md:h-[354px] bg-gradient-to-br from-blue-400/20 to-purple-600/20 rounded-3xl flex items-center justify-center">
                                <Image className="grayscale-100 " src={"/use_cases_illus/ecom_illus.png"} width={530} height={354} alt="" />
                            </div>
                        </motion.div>
                    </div>
                ...
                <div className=" h-[150vh] md:h-[135vh] w-full">
                    <div className="flex flex-col-reverse md:flex-row justify-between gap-5 pb-10 md:pb-0 ">
                        ...
                        <motion.div
                            ...
                            className="relative p-10"
                        >
                            <div className="md:w-[530px] md:h-[354px] p-18 bg-gradient-to-br from-blue-400/20 to-purple-600/20 rounded-3xl flex items-center justify-center">
                                <Image className=" grayscale-100 " src={"/use_cases_illus/online_illus.png"} width={530} height={354} alt="" />
                            </div>
                        </motion.div>
                ...
                <div className=" h-[150vh] md:h-[135vh] w-full">
                    <div className="flex flex-col-reverse md:flex-row justify-between gap-5 pb-10 md:pb-0">
                        ...
                        <motion.div
                            ...
                            className="relative p-10"
                        >
                            <div className="md:w-[530px] md:h-[354px] p-24 bg-gradient-to-br from-blue-400/20 to-blue-600/20 rounded-3xl flex items-center justify-center">
                                <Image className=" grayscale-100  " src={"/use_cases_illus/brand_illus.png"} width={530} height={354} alt="" />
                            </div>
                        </motion.div>
                    </div>
                ...
                <div className=" h-[150vh] md:h-[135vh] w-full">
                    <div className="flex flex-col-reverse md:flex-row justify-between gap-5 pb-10 md:pb-0 ">
                        ...
                        <motion.div
                            ...
                            className="relative p-10"
                        >
                            <div className="md:w-[530px] md:h-[354px] p-28 bg-gradient-to-br from-blue-400/20 to-blue-600/20 rounded-3xl flex items-center justify-center">
                                <Image className="grayscale-100" src={"/use_cases_illus/digital_illus.png"} width={370} height={354} alt="" />
                            </div>
                        </motion.div>
