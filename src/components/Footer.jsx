        ...
        <div className=" mb-10 flex flex-col items-center text-white">
            ...
            <div className=" relative text-white border border-white flex gap-10 md:gap-0 flex-col md:flex-row md:items-center justify-between px-10 py-10 md:py-0 rounded-3xl md:rounded-full h-full md:h-20 w-[97vw] mb-20 ">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-8">
                    ...
                    <Link className=" cursor-pointer hover:text-gray-100 " href={"/blogs"}>Blogs</Link>
                    ...
                    <Link className=" cursor-pointer hover:text-gray-100 " href={"/terms-of-use"}>Terms of Use</Link>
                    {/* <Link className=" cursor-pointer hover:text-gray-100 " href={"/terms-n-conditions"}>Terms & conditions</Link> */}
                </div>
            </div>

            <div className="flex flex-col-reverse md:flex-row w-full px-16 gap-3 md:gap-0 justify-between">
                <span className="text-base md:text-sm">© {new Date().getFullYear()} Contrails AI. All rights reserved.</span>
                <div className="flex items-center gap-5">
                    {/* Twitter */}
                    <Link href={"https://x.com/contrails_ai"} target="_blank" >
                    ...
                    {/* LINKEDIN */}
                    <Link href={"https://www.linkedin.com/company/contrails-ai"} target="_blank" >
